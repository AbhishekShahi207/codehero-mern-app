...
import { AlignRight, Badge, ChevronRightIcon, Code2Icon, MoveRight } from "lucide-react";
...
<p className='text-base-content/70'>Sharpen your coding skill with these curated problem</p>
</div>
...
<div className='text-success '>
  <button className='btn btn-primary hover:scale-105'><span className='font-medium'>Solve</span><ChevronRightIcon/></button>
