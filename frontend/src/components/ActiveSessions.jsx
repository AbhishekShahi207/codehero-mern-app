...
function ActiveSessions({ sessions, isLoading, isUserInSession }) {
  return (
    <div className="lg:col-span-2 bg-base-100 border-2 border-primary/20 hover:border-primary/30 h-full">
      <div className="card-body">
        {/* HEader Section */}
        <div className="flex items-center justify-between mb-6">
          {/* Title and icon */}
          <div className="flex items-center gap-3">
            <div className="p-1 md:p-2 bg-gradient-to-br from bg-primary to secondary rounded-xl">
